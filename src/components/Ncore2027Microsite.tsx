    ...
    <>
      ...
      <div className="relative overflow-hidden rounded-[2rem]" style={{
        ...
        <div className="relative z-10 mx-6 mt-4 mb-6" style={{ minHeight: 300 }}>
          ...
          <div className="absolute pointer-events-none" style={{ left: "21%", top: "30%", transform: "translateX(-50%)" }}>
            <span style={{
          ...
          <div className="absolute pointer-events-none" style={{ left: "21%", top: "43%" }}>
            <div style={{
